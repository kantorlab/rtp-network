...
The CTDB included disease intervention specialist interview data from `r length(ind_in_partner_db)` unique persons (`r length(unique(net_dt$StudyIDFrom))` newly diagnosed; `r length(unique(net_dt$StudyIDTo))` named partners). 
</span>
