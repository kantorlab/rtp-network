...
-   [ Of these,
    ...
    are clustered phylogenetically.]{style="background-color: #FFFF00"} (per `clusteredphyloany`)

-   [ Of these,
    `r table(individuals_dt[individuals_in_net_dt_studyidfrom_wo_emptyStudyIDTo]$ClusteredHIVTrace005, exclude=NULL)`
    are clustered phylogenetically.]{style="background-color: #FFFF00"} (per `Trace 005`) - subtract blank entries
    
-   [ Of these,
    `r table(individuals_dt[individuals_in_net_dt_studyidfrom_wo_emptyStudyIDTo]$ClusteredHIVTrace015, exclude=NULL)`
    are clustered phylogenetically.]{style="background-color: #FFFF00"} (per `Trace 005`) - subtract blank entries
