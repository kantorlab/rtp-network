...
genomic_db <- genomic_db_full[Sequence == "True",,]
```
...
results_phyloany_converse <- 
  predict_clustering_indicator(individuals_in_named_pt_net_dt, "phyloany")
```
