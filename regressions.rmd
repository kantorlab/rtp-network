...
linked to at least one of their named partners [i.e, Characterization of
Molecular Clusters in Named Partners]
...
split_named_pt_indicator_counts_by_attributes(data=genomic_db_w_index_persons_in_clusteredphyloany)
