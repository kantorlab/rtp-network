...
```{r}
#na_val <- c(which(genomic_db_w_index_persons_in_005$DemoGender == ""))
#data2 <- genomic_db_w_index_persons_in_clusteredphyloany
m1 <- geeglm(as.numeric(as.character(named_partner_indicator)) ~ 
             DemoGender, 
...
m2 <- geeglm(as.numeric(as.character(named_partner_indicator)) ~ 
             DemoRace, 
           data = genomic_db_w_index_persons_in_clusteredphyloany, 
            family = "binomial", 
           id=ClusteredPhyloAny, 
...
m3 <- geeglm(as.numeric(as.character(named_partner_indicator)) ~ 
...
m4 <- geeglm(as.numeric(as.character(named_partner_indicator)) ~ 
             RiskMSM, 
           data = genomic_db_w_index_persons_in_clusteredphyloany, 
            family = "binomial", 
           id=ClusteredPhyloAny, 
...
m5 <- geeglm(as.numeric(as.character(named_partner_indicator)) ~ 
             RiskHeterosexual, 
           data = genomic_db_w_index_persons_in_clusteredphyloany, 
            family = "binomial", 
           id=ClusteredPhyloAny, 
...
m6 <- geeglm(as.numeric(as.character(named_partner_indicator)) ~ 
             RiskIDU, 
           data = genomic_db_w_index_persons_in_clusteredphyloany, 
            family = "binomial", 
           id=ClusteredPhyloAny, 
...
# m7 <- geeglm(as.numeric(as.character(named_partner_indicator)) ~ 
#              HIVDxAge, 
#            data = genomic_db_w_index_persons_in_clusteredphyloany, 
#             family = "binomial", 
#            id=ClusteredPhyloAny, 
