...
[i.e, Characterization of Molecular Clusters in Named Partners]
...
```
[Thus, there are `r nrow(genomic_db_w_index_persons_in_clusteredphyloany)`
    who are clustered phylogenetically by the `phyloany` method.
    Of these, `r length(which(genomic_db_w_index_persons_in_clusteredphyloany$named_partner_indicator == 1))`]{style="background-color: #FFFF00"}
...
Trace 005:
```{r}
table(genomic_db_w_index_persons_in_005$named_partner_indicator, exclude = NULL)

## DemoGender
table(genomic_db_w_index_persons_in_005$DemoGender, exclude = NULL)
xtabs(~factor(genomic_db_w_index_persons_in_005$DemoGender, exclude = NULL) +
  factor(genomic_db_w_index_persons_in_005$named_partner_indicator, exclude = NULL)
   )
   
## DemoRace
table(genomic_db_w_index_persons_in_005$DemoRace, exclude = NULL)
xtabs(~factor(genomic_db_w_index_persons_in_005$DemoRace, exclude = NULL) +
factor(genomic_db_w_index_persons_in_005$named_partner_indicator, exclude = NULL)
 )

## Sequence
table(genomic_db_w_index_persons_in_005$RecodedSequenceSubtype, exclude = NULL)
xtabs(~factor(genomic_db_w_index_persons_in_005$RecodedSequenceSubtype, exclude = NULL) +
factor(genomic_db_w_index_persons_in_005$named_partner_indicator, exclude = NULL)
 )

## MSM
table(genomic_db_w_index_persons_in_005$RiskMSM, exclude = NULL)
xtabs(~factor(genomic_db_w_index_persons_in_005$RiskMSM, exclude = NULL) +
factor(genomic_db_w_index_persons_in_005$named_partner_indicator, exclude = NULL)
 )

## Heterosexual
table(genomic_db_w_index_persons_in_005$RiskHeterosexual, exclude = NULL)
xtabs(~factor(genomic_db_w_index_persons_in_005$RiskHeterosexual, exclude = NULL) +
factor(genomic_db_w_index_persons_in_005$named_partner_indicator, exclude = NULL)
 )

## IDU
table(genomic_db_w_index_persons_in_005$RiskIDU, exclude = NULL)
xtabs(~factor(genomic_db_w_index_persons_in_005$RiskIDU, exclude = NULL) +
factor(genomic_db_w_index_persons_in_005$named_partner_indicator, exclude = NULL)
 )

## age at HIV diagnosis
summary(genomic_db_w_index_persons_in_005$HIVDxAge)
...
## DemoGender
table(genomic_db_w_index_persons_in_015$DemoGender, exclude = NULL)
xtabs(~factor(genomic_db_w_index_persons_in_015$DemoGender, exclude = NULL) +
  factor(genomic_db_w_index_persons_in_015$named_partner_indicator, exclude = NULL)
   )
   
## DemoRace
table(genomic_db_w_index_persons_in_015$DemoRace, exclude = NULL)
xtabs(~factor(genomic_db_w_index_persons_in_015$DemoRace, exclude = NULL) +
factor(genomic_db_w_index_persons_in_015$named_partner_indicator, exclude = NULL)
 )

## Sequence
table(genomic_db_w_index_persons_in_015$RecodedSequenceSubtype, exclude = NULL)
xtabs(~factor(genomic_db_w_index_persons_in_015$RecodedSequenceSubtype, exclude = NULL) +
factor(genomic_db_w_index_persons_in_015$named_partner_indicator, exclude = NULL)
 )

## MSM
table(genomic_db_w_index_persons_in_015$RiskMSM, exclude = NULL)
xtabs(~factor(genomic_db_w_index_persons_in_015$RiskMSM, exclude = NULL) +
factor(genomic_db_w_index_persons_in_015$named_partner_indicator, exclude = NULL)
 )

## Heterosexual
table(genomic_db_w_index_persons_in_015$RiskHeterosexual, exclude = NULL)
xtabs(~factor(genomic_db_w_index_persons_in_015$RiskHeterosexual, exclude = NULL) +
factor(genomic_db_w_index_persons_in_015$named_partner_indicator, exclude = NULL)
 )

## IDU
table(genomic_db_w_index_persons_in_015$RiskIDU, exclude = NULL)
xtabs(~factor(genomic_db_w_index_persons_in_015$RiskIDU, exclude = NULL) +
factor(genomic_db_w_index_persons_in_015$named_partner_indicator, exclude = NULL)
 )

## age at HIV diagnosis
summary(genomic_db_w_index_persons_in_015$HIVDxAge)
...
## DemoGender
table(genomic_db_w_index_persons_in_clusteredphyloany$DemoGender, exclude = NULL)
xtabs(~factor(genomic_db_w_index_persons_in_clusteredphyloany$DemoGender, exclude = NULL) +
  factor(genomic_db_w_index_persons_in_clusteredphyloany$named_partner_indicator, exclude = NULL)
   )
   
## DemoRace
table(genomic_db_w_index_persons_in_clusteredphyloany$DemoRace, exclude = NULL)
xtabs(~factor(genomic_db_w_index_persons_in_clusteredphyloany$DemoRace, exclude = NULL) +
factor(genomic_db_w_index_persons_in_clusteredphyloany$named_partner_indicator, exclude = NULL)
 )

## Sequence
table(genomic_db_w_index_persons_in_clusteredphyloany$RecodedSequenceSubtype, exclude = NULL)
xtabs(~factor(genomic_db_w_index_persons_in_clusteredphyloany$RecodedSequenceSubtype, exclude = NULL) +
factor(genomic_db_w_index_persons_in_clusteredphyloany$named_partner_indicator, exclude = NULL)
 )

## MSM
table(genomic_db_w_index_persons_in_clusteredphyloany$RiskMSM, exclude = NULL)
xtabs(~factor(genomic_db_w_index_persons_in_clusteredphyloany$RiskMSM, exclude = NULL) +
factor(genomic_db_w_index_persons_in_clusteredphyloany$named_partner_indicator, exclude = NULL)
 )

## Heterosexual
table(genomic_db_w_index_persons_in_clusteredphyloany$RiskHeterosexual, exclude = NULL)
xtabs(~factor(genomic_db_w_index_persons_in_clusteredphyloany$RiskHeterosexual, exclude = NULL) +
factor(genomic_db_w_index_persons_in_clusteredphyloany$named_partner_indicator, exclude = NULL)
 )

## IDU
table(genomic_db_w_index_persons_in_clusteredphyloany$RiskIDU, exclude = NULL)
xtabs(~factor(genomic_db_w_index_persons_in_clusteredphyloany$RiskIDU, exclude = NULL) +
factor(genomic_db_w_index_persons_in_clusteredphyloany$named_partner_indicator, exclude = NULL)
 )

## age at HIV diagnosis
summary(genomic_db_w_index_persons_in_clusteredphyloany$HIVDxAge)
res <-
...
# Regressions Analysis: Predict Partner Naming from Molecular Clusters

```{r}
result_005 <- predict_named_partner_indicator(genomic_db_w_index_persons_in_005)
result_015 <- predict_named_partner_indicator(genomic_db_w_index_persons_in_015)
result_clusteredphyloany <-predict_named_partner_indicator(
  genomic_db_w_index_persons_in_clusteredphyloany)
```


# Regressions Analysis: Predict Molecular Clustering of Named Partnerships
...
[Thus, there are `r length(individuals_in_named_pt_net_dt$indicator_phyloany_cluster)`
    who are in named partnerships in partner DB. 
    OF these, `r length(which(individuals_in_named_pt_net_dt$indicator_phyloany_cluster == 1))` clustered phylogenetically by the `phyloany` method, and
