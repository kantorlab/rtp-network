...
# Sample data 
df <- data.frame(
  category = c("Gender: Male", "Gender: Non-binary", "Race: Asian", "Race: Other", "Race: White", "Sequence: not B", "Behavior: MSM", "Behavior: HRH", 
               "Behavior: PWID", "Age at HIV Diagnosis"),
  log_odds = c(-0.2188, -0.2446, 1.18474, -0.42470, 0.09366, -0.29668, -0.20453, 0.16108, 0.40669, 0.006576),
  std_error = c(0.1401, 0.4390, 0.55928, 0.33584, 0.13478, 0.22138, 0.11835, 0.12797, 0.19599, 0.004724)
)
